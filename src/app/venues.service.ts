...
export class VenuesService {
  ...
  venues: Venue[] = [
    ...
    },
    {
      ...
      Link1:
        "https://www.20monroelive.com//EventDetail?tmeventid=080057672FCD748E&offerid=115098",
      E2: [" Gin Blossoms",  " Tues April 21",  " 7PM"],
      Link2:
        "https://www.20monroelive.com//EventDetail?tmeventid=0800583F096F71B9&offerid=119495",
    ...
    },
    {
      ...
      Link1:
        "https://www.vanandelarena.com/events/2020/elton-john-farewell-yellow-brick-road-tour",
      E2: [" Jurrassic World Live Tour",  " Thurs Oct 15",  " 7PM"],
      Link2:
        "https://www.vanandelarena.com/events/2020/jurassic-world-live-tour",
    ...
    },
    {
      ...
      Link1:
        "https://pyramidschemebar.com/event/music-against-human-trafficking/",
    ...
    },
    {
      ...
      Link2:
        "https://www.meijergardens.org/calendar/tuesday-evening-music-club/",
  ...
  getVenue(): Venue[] {
    for (const venue of this.venues) {
      venue.info = [
    '<div class="v_name">'+ venue.Name + '</div>'+
    '<div class="v_address">'+ venue.Address + '</div>'+
    '<div class="v_event">'+ venue.E1 + '</div>'+ 
    '<div class="v_event">'+ venue.E2 + '</div>'+
    '<a class="v_link" href="'+ venue.Site +'" target="_blank">'+ venue.Site +'/>'
      ];
    }
    return this.venues;
  }
